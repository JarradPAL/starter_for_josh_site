        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 article-cent">
                    <img src="http://206.189.45.97/~mesh19/wp-content/uploads/2020/04/portrait.jpg" class="img-responsive" alt="Portrait">
                    <h4>A PORTRAIT</h4>
                ...
                <div class="col-md-4 article-cent">
                    <img src="http://206.189.45.97/~mesh19/wp-content/uploads/2020/04/model.jpg" class="img-responsive" alt="MODEL">
                    <h4>A MODEL</h4>
                    <p class="date">12 December 2020</p>
                    <p>STS has never been shy of seeking new terrains of investigation. More and more STS s cholars are starting to explore and intervene in the arts. This object of study brings new challenges and opportunities that we want to explore in this session. We would like to gather first of all simply new kinds of knowledge arising from STS study of the arts. </p>
                    <p class="readmore">CONTINUE READING</p>
                ...
                <div class="col-md-4 article-cent">
                    <img src="http://206.189.45.97/~mesh19/wp-content/uploads/2020/04/design.jpg" class="img-responsive" alt="GAME DESIGN">
                    <h4>A PORTRAIT</h4>
                    <p class="date">12 December 2020</p>
                    <p>STS has never been shy of seeking new terrains of investigation. More and more STS s cholars are starting to explore and intervene in the arts. This object of study brings new challenges and opportunities that we want to explore in this session. We would like to gather first of all simply new kinds of knowledge arising from STS study of the arts. </p>
                    <p class="readmore">CONTINUE READING</p>
